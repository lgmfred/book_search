defmodule BookSearch.AuthorsTest do
  ...
  describe "authors" do
    ...
    test "list_authors/1 _ matching a name" do
      author = author_fixture(name: "Chinua Achebe")
      assert Authors.list_authors("Chinua Achebe") == [author]
    end

    test "list_authors/1 _ non matching name" do
      _author = author_fixture(name: "Chinua Achebe")
      assert Authors.list_authors("Alain Mabanckou") == []
    end

    test "list_authors/1 _ partially matching name" do
      author = author_fixture(name: "Alain Mabanckou")
      assert Authors.list_authors("Alain") == [author]
      assert Authors.list_authors("ain") == [author]
      assert Authors.list_authors("Mabanckou") == [author]
    end
